            ...
            for delay_i = 1:size(time_segments, 1)
                ...
                for perf_i = 1:length(performance)
                    ...
                    for sequence_length = [3 4 34]
                        ...
                        load([path_results_original '/' subject_ID '/' func2str(fun_i) ...
                            '/' performance{perf_i} '/' events{event_i} '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2)) ...
                        ...
                        % eigenvectors (delay)
                        X_correct_trials = load([path_results_original '/' subject_ID '/' func2str(fun_i) ...
                            '/correct_trials/delay_1to4000/X_matrix_' sequence_length_filename '.mat']);
                        X_correct_trials = X_correct_trials.X;

                        %% randomization

                        if ~isfolder([path_results '/stim_rand' num2str(random_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i} '/' ...
                                events{event_i} '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))])
                            mkdir([path_results '/stim_rand' num2str(random_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i} '/' ...
                                events{event_i} '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))]);
                        end
                        ...
                        if ~isfile([path_results '/stim_rand' num2str(random_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i}...
                                '/' events{event_i} '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))...
                            ...
                            save([path_results '/stim_rand' num2str(random_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i}...
                                '/' events{event_i} '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))...
                        ...
                        if ~isfile([path_results '/stim_rand' num2str(random_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i}...
                            ...
                            load([path_results '/stim_rand' num2str(random_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i}...
                                '/' events{event_i} '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))...
