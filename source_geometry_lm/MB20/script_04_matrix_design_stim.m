...
% path to data
if isfolder('/Users/as14864/Data/Analysis/GERE')
    path_inputs = ['/Users/as14864/Data/Analysis/GERE/results/preprocessing/' folder_prep];
    path_results = ['/Users/as14864/Data/Analysis/GERE/results/source_geometry_lm/' folder_geometry];
    addpath('/Users/as14864/Data/Analysis/GERE/scripts/source_geometry_lm/utilities')
else
    path_inputs = ['/scratch/as14864/GERE/results/preprocessing/' folder_prep];
    path_results = ['/scratch/as14864/GERE/results/source_geometry_lm/' folder_geometry];
    addpath('/scratch/as14864/GERE/scripts/source_geometry_lm/utilities')
end
...
for fun_i = functions_data
    ...
    for time_i = 1:size(time_segments, 1)
        ...
        disp(['stim_resolved_refined_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2))]);
...
for sequence_length = [3 4 34]
    ...
    if sequence_length == 3
        ...
        time_segments = time_segments(2:4,:);
        ...
        for time_i = 1:size(time_segments, 1)
            ...
            for perf_i = 1:length(performance)
                ...
                if ~isfile([path_results '/group_results/principal_angle/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'...
                    '/between_within_stim_resolved_refined_' sequence_length_filename '_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2)) '.txt'])
            ...
            for perf_i = 1:length(performance)
                ...
                if ~isfile([path_results '/group_results/vaf/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'...
                    ...
                    for sub_i = 1:length(subjects)
                        ...
                        load([path_results '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i} ...
                            '/stim_resolved_refined_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2))...
                            '/vaf_' sequence_length_filename '.mat']); % angle
