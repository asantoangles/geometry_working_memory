                    ...
                    for sequence_length = [3 4 34]
                        ...
                        if ~isfile([path_results '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i}...
                            ...
                            for iter_i = 1:iterations_bootstrap
                                ...
                                [angle_bootstrap_alliter(:,:,iter_i), vaf_bootstrap_alliter(:,:,iter_i)] = compute_angle_vaf_within(planes_split1, planes_split2, Y_r, score, ranks);
