...
setwd("/path_to_local/scripts/source_geometry_lm/MB20/supplementary_results_4locations")
...
folder_figures = "MB20"
path_figures = paste("/path_to_local/results/source_geometry_lm/", folder_figures, "/supplementary_results_4locations", sep = "")
...
folder = "MB20_controlled_resampling"
path_results = paste("/path_to_local/results/source_geometry_lm/", folder, sep = "")
