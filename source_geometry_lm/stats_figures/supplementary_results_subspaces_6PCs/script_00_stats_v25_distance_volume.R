...
folder_source = "LB20_allPCs_accumulated/comp1to6"
path_results = paste("/path_to_local/results/source_geometry_lm/", folder_source, sep = "")

folder_source_random = "LB20_random_comp1to6"
...
write.table(p_values, file = "p_values_distance_volume_LB20.csv", sep = ",", row.names = FALSE, col.names = TRUE)
