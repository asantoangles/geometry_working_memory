...
setwd("/path_to_local/scripts/source_geometry_lm/LB20/supplementary_results_subspaces_6PCs")
...
folder_figures = "LB20"
path_figures = paste("/path_to_local/results/source_geometry_lm/", folder_figures, "/supplementary_results_subspaces_6PCs", sep = "")
...
folder = "LB20_allPCs_accumulated/comp1to6"
path_results = paste("/path_to_local/results/source_geometry_lm/", folder, sep = "")

folder_random = "LB20_random_comp1to6"
...
metrics = c("principal_angle_min", "vaf")
...
folder = "LB20_controlled_resampling_allPCs_accumulated/comp1to6"
path_results = paste("/path_to_local/results/source_geometry_lm/", folder, sep = "")
