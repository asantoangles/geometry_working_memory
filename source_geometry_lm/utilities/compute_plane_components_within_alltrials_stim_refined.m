function [planes_split1, planes_split2, Y_r, score] = compute_plane_components_within_alltrials_stim_refined(X_all_trials, X_split1, X_split2, components, stim_order)

% compute_plane_components_within_alltrials_stim_refined is an adaptation of 
% compute_plane_components_alltrials.m designed to compute 
% within-subspace planes during stimulus presentation, enabling the quantification of 
