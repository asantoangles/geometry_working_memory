...
for last_comp_i = [6 8]
    ...
    for fun_i = functions_data
        ...
        for delay_i = 1:size(time_segments, 1)
            ...
            disp(['delay_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))]);
            ...
            for sequence_length = [3 4 34]
                ...
                for perf_i = 1:length(performance)
                    ...
                    if ~isfile([path_results '/group_results/volume/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'...
                        '/design_matrix_delay_' sequence_length_filename '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2)) '.txt'])
                        ...
                        for sub_i = 1:length(subjects)
                            ...
                            load([path_results '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i} ...
                                '/delay_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))...
                                ...
                                if length(separability.distance_by_separation{1}) ~= 7 || ...
                                   ...
                                   length(separability.distance_by_separation{3}) ~= 7 
                                    ...
                                    distance_delay = [separability.distance_by_separation{1}; 
                                                      separability.distance_by_separation{2}; 
                                                      separability.distance_by_separation{3}];
                                end
                                ...
                                if length(separability.distance_by_separation{1}) ~= 7 || ...
                                   ...
                                   length(separability.distance_by_separation{4}) ~= 7
                                    ...
                                    distance_delay = [separability.distance_by_separation{1}; 
                                                      separability.distance_by_separation{2}; 
                                                      separability.distance_by_separation{3}; 
                                                      separability.distance_by_separation{4}];
                                end
    ...
    for fun_i = functions_data
        ...
        for delay_i = 1:size(time_segments, 1)
            ...
            disp([func2str(fun_i) ' delay_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2))]);
            ...
            for sequence_length = [3 4 34]
                ...
                for perf_i = 1:length(performance)
                    ...
                    if ~isfile([path_results '/group_results/principal_angle_min/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'...
                        '/between_within_delay_' sequence_length_filename '_' num2str(time_segments(delay_i,1)) 'to' num2str(time_segments(delay_i,2)) '.txt'])
