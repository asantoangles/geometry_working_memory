...
if subset_i == 1
    delay_segments = delay_segments(1:4,:);
elseif subset_i == 2
    delay_segments = delay_segments(5:8,:);
elseif subset_i == 3
    delay_segments = delay_segments(9:12,:);
elseif subset_i == 4
    delay_segments = delay_segments(13:16,:);
end
                ...
                for sub_i = 1:length(subjects)
                    ...
                    for fun_i = functions_data
                        ...
                        for delay_i = 1:size(time_segments, 1)
                            ...
                            angle_min_perm = nan(ranks,ranks,permutations);
                            ...
                            if ~isfile([path_results '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i}...
                                ...
                                for perm_i = 1:permutations
                                    ...
                                    [angle_min_perm(:,:,perm_i), angle_perm(:,:,perm_i), vaf_perm(:,:,perm_i)] = compute_angle_vaf_accumulated(planes, ranks);
