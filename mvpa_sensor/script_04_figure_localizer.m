...
%% figure decoding localizer best classifier
...
for input_i = 1:length(inputs)
    ...
    for class_i = 1:length(classifiers)
        ...
        load([path_results '/group_results/localizer_twoclass/' inputs{input_i} '/' classifier...
            '/stats_withingroup_balanced_perm' num2str(cfg_stat.n_permutations) '.mat']);
        ...
        try
            ...
            saveas(gcf, [path_results '/group_results/localizer_twoclass/' inputs{input_i} '/' classifier...
                '/figure_stats_withingroup_balanced_perm' num2str(cfg_stat.n_permutations) '_v2.fig']);
            close all
        ...
        saveas(fig, [path_results '/group_results/localizer_twoclass/' inputs{input_i} '/' classifier...
                '/figure_stats_withingroup_balanced_perm' num2str(cfg_stat.n_permutations) '_v2.jpeg']);
        close all
