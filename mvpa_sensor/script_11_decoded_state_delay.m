...
%% decoded state space (subject-specific) task_stim2delay
    ...
    for ses_i = 1:length(sessions)
        ...
        for class_i = 1:length(classifiers)
            ...
            for input_i = 1:length(inputs)
                ...
                if ~isfile([path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier '/predictions.mat'])
        
                    if ~isfolder([path_results '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier])
                        mkdir([path_results '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier]);
                    end

                    if ~isfolder([path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier])
                        mkdir([path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier]);
                    end
                    ...
                    for stim_i = 1:number_stimuli
                        ...
                        save([path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier...
                        ...
                        predictionstim = dval_all;
    
                        filename_output = [path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier...
                    ...
                    save([path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier '/predictions.mat'], 'predictions', '-v7.3');
    
                    system(['rm ' path_predictions '/' subject_ID '/' session_ID '/task_stim2delay/' inputs{input_i} '/' classifier...
...
%% decoded state space (subject-specific) localizer2delay
    ...
    for ses_i = 1:length(sessions)
        ...
        for class_i = 1:length(classifiers)
            ...
            for input_i = 1:length(inputs)
                ...
                if ~isfile([path_predictions '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier '/predictions.mat'])
                        
                    if ~isfolder([path_results '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier])
                        mkdir([path_results '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier]);
                    end

                    if ~isfolder([path_predictions '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier])
                        mkdir([path_predictions '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier]);
                    end
                    ...
                    for stim_i = 1:number_stimuli
                        ...
                        %% prepare localizer data
    
                        % load data localizer
                        load([path_preprocessed_data '/' subject_ID '/' session_ID...
                                '/GERE_localizer_validtrialszthr25_postICA.mat']); % data
                        ...
                        if strcmp(inputs{input_i}, 'bins')
                            ...
                            X_besttime_1tp = X_all(:,:,best_time);
                        ...
                        % set classes
                        clabel_train = data_localizer.trialinfo(:,3);
                        clabel_train(clabel_train == stim_i) = 100;
                        clabel_train(clabel_train < 100) = 2;
                        clabel_train(clabel_train == 100) = 1;
                        ...
                        save([path_predictions '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier...
                                '/weights_location' num2str(stim_i) '.mat'], 'cf', '-v7.3');
                        ...
                        filename_output = [path_predictions '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier...
                                '/predictions_stim' num2str(stim_i) '.mat'];
                    ...
                    for stim_i = 1:number_stimuli
                        ...
                        filename_output = [path_predictions '/' subject_ID '/' session_ID ...
                            '/localizer2delay/' inputs{input_i} '/' classifier...
                                '/predictions_stim' num2str(stim_i) '.mat'];
                    ...
                    save([path_predictions '/' subject_ID '/' session_ID '/localizer2delay/' inputs{input_i} '/' classifier '/predictions.mat'], 'predictions', '-v7.3');

                    system(['rm ' path_predictions '/' subject_ID '/' session_ID ...
                                '/localizer2delay/' inputs{input_i} '/' classifier...
                                    '/predictions_stim*']);
