...
folder_neural_sequences = 'sequence_concat_stim';
...
for folder_i = 1:length(folders)
    ...
    for sub_i = 1:length(subjects)
        ...
        if ~isfile([outdir '/Msb_l3.mat'])
            ...
            [Msf_l3, Msb_l3] = TDLM_concatenate_stim(X_l3,T_l3,3,nlags,nshuf_l3,X_l3_trials);
            save([outdir '/Msf_l3.mat'], 'Msf_l3', '-v7.3');
            save([outdir '/Msb_l3.mat'], 'Msb_l3', '-v7.3');

        end

        if ~isfile([outdir '/Msb_l4.mat'])
        
            [Msf_l4, Msb_l4] = TDLM_concatenate_stim(X_l4,T_l4,4,nlags,nshuf_l4,X_l4_trials);
