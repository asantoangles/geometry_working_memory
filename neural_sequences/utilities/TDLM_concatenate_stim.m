function [Msf, Msb] = TDLM_concatenate_stim(X,T,nstates,nlags,nshuf,X_trials)

% TDLM_concatenate_stim is a version of 
% TDLM_concatenate adapted for the stimulus period. 
% For full documentation, see TDLM_concatenate.m
%
