...
folder_neural_sequences = 'sequence_concat_delay';
...
path_results = [path_root, '/results/neural_sequences/supplementary_exclude1/' folder_neural_sequences];
...
for folder_i = 1:length(folders)
    ...
    for sub_i = 1:length(subjects)
        ...
        outdir = [path_results '/' subject_ID '/bins/' classifier '/TDLM_sequence/' folders{folder_i} '/prob/whole_delay'];
