...
folder_source = "NB23_PC1"
path_results = paste("/path_to_local/results/neural_subspaces/", folder_source, sep = "")

folder_source_random = "NB23_PC1_random"
path_results_random = paste("/path_to_local/results/neural_subspaces/", folder_source_random, sep = "")
...
folder = "NB23_PC1_controlled_resampling"
...
p_values_uncorrected = c(p_values_003_pa, p_values_003_vaf, p_values_003_pa_random, p_values_003_vaf_random,
                         p_values_004_pa, p_values_004_vaf, 
                         p_values_005_pa, p_values_005_vaf, 
                         p_values_006_distance, p_values_006_volume,
                         p_values_007_distance, p_values_007_volume)

t_values = c(t_values_003_pa, t_values_003_vaf, t_values_003_pa_random, t_values_003_vaf_random, 
             t_values_004_pa, t_values_004_vaf, 
             t_values_005_pa, t_values_005_vaf, 
             t_values_006_distance, t_values_006_volume, 
             t_values_007_distance, t_values_007_volume)


list_stats = c(rep('pa_bt_wt', length(p_values_003_pa)), rep('vaf_bt_wt', length(p_values_003_vaf)),
               rep('pa_bt_su', length(p_values_003_pa_random)), rep('vaf_bt_su', length(p_values_003_vaf_random)),
               rep('pa_perf', length(p_values_004_pa)), rep('vaf_perf', length(p_values_004_vaf)),
               rep('pa_length', length(p_values_005_pa)), rep('vaf_perf', length(p_values_005_vaf)),
