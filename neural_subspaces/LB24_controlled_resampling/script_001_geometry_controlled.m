...
folder_outputs = 'LB24_controlled_resampling';
        ...
        for seg_i = 1:size(time_segments, 1)
            ...
            for perf_i = 1:length(performance)
                ...
                for sequence_length = [3 4]
                    ...
                    if sequence_length == 3
                        indir_correct = [path_inputs '/' subject_ID '/' func2str(fun_i) '/correct_trials/stim_800to1100'];
                    elseif sequence_length == 4
                        indir_correct = [path_inputs '/' subject_ID '/' func2str(fun_i) '/correct_trials/stim_1200to1500'];
                    end
