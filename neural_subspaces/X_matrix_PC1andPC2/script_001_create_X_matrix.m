...
folder_outputs = 'X_matrix_PC1andPC2';
...
path_inputs = [path_root '/results/source_reconstruction_PC1andPC2'];
        ...
        for perf_i = 1:length(performance)
            ...
            for ses_i = 1:length(sessions)
                ...
                load([path_inputs '/' subject_ID '/' session_ID ...
                    '/data_nonlinear_atlas' num2str(number_parcels) '_task_zthr25_PC1andPC2regress_ortho.mat']);
