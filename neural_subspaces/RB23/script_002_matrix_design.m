    ...
    for time_i = 1:size(time_segments, 1)
        ...
        for sequence_length = [3 4]
            ...
            for perf_i = 1:length(performance)
                ...
                outdir_volume = [path_results '/supp' num2str(supp_i) '/group_results/volume/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'];
                outdir_distance = [path_results '/supp' num2str(supp_i) '/group_results/distance/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'];
                ...
                if ~isfile([outdir_volume '/delay_' seq_name '_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2)) '.txt'])
                    ...
                    for sub_i = 1:length(subjects)
                        ...
                        indir = [path_results '/supp' num2str(supp_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i} '/delay_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2))];
            ...
            for perf_i = 1:length(performance)
                ...
                if ~isfile([outdir_volume '/stim_' seq_name '_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2)) '.txt'])
                    ...
                    for sub_i = 1:length(subjects)
                        ...
                        indir = [path_results '/supp' num2str(supp_i) '/' subject_ID '/' func2str(fun_i) '/' performance{perf_i} '/stim_' num2str(time_segments(time_i,1)) 'to' num2str(time_segments(time_i,2))];
    ...
    for time_i = 1:size(time_segments, 1)
        ...
        for sequence_length = [3 4]
            ...
            for perf_i = 1:length(performance)
                ...
                outdir = [path_results '/supp' num2str(supp_i) '/group_results/principal_angle/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'];
    ...
    for time_i = 1:size(time_segments, 1)
        ...
        for sequence_length = [3 4]
            ...
            for perf_i = 1:length(performance)
                ...
                outdir = [path_results '/supp' num2str(supp_i) '/group_results/vaf/' func2str(fun_i) '/' performance{perf_i} '/design_matrix'];
