function [volume, distance_by_separation] = compute_separability_metrics_highdim(points)
...
try
    ...
    try
        ...
        points_ = points(E(1:rank_points), E(1:rank_points));

        % add zero point
        points_(end+1, :) = 0;

        [~, volume] = convhulln(points_);
