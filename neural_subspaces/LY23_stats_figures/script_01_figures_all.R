...
main_folder = "LY23_stats_figures"
setwd(paste("/path_to_local/scripts/neural_subspaces/", main_folder, sep = ""))
...
path_figures = paste("/path_to_local/results/neural_subspaces/", main_folder, sep = "")
...
folder = "LY23"
path_results = paste("/path_to_local/results/neural_subspaces/", folder, sep = "")

folder_random = "LY23_random"
path_results_random = paste("/path_to_local/results/neural_subspaces/", folder_random, sep = "")

performance = c("correct_trials")
functions_data = c("mean")
metrics = c("principal_angle", "principal_angle_min", "vaf")
...
first_idx = last_idx + 1
last_idx = last_idx + length(p_values_003_pa_min)
p_values_fdr_003_pa_min = p_values_fdr_plots[first_idx:last_idx]

first_idx = last_idx + 1
last_idx = last_idx + length(p_values_003_vaf) 
p_values_fdr_003_vaf = p_values_fdr_plots[first_idx:last_idx]

p_values_all = c(p_values_fdr_003_pa, p_values_fdr_003_pa_min, p_values_fdr_003_vaf)
...
first_idx = last_idx + 1
last_idx = last_idx + length(p_values_003_pa_min_random) 
p_values_fdr_003_pa_min_random = p_values_fdr_plots[first_idx:last_idx]

first_idx = last_idx + 1
last_idx = last_idx + length(p_values_003_vaf_random) 
p_values_fdr_003_vaf_random = p_values_fdr_plots[first_idx:last_idx]

p_values_all_random = c(p_values_fdr_003_pa_random, p_values_fdr_003_pa_min_random, p_values_fdr_003_vaf_random)
...
folder = "LY23_controlled_resampling"
path_results = paste("/path_to_local/results/neural_subspaces/", folder, sep = "")
...
first_idx = last_idx + 1
last_idx = last_idx + length(p_values_004_pa_min) 
p_values_fdr_004_pa_min = p_values_fdr_plots[first_idx:last_idx]

first_idx = last_idx + 1
last_idx = last_idx + length(p_values_004_vaf) 
p_values_fdr_004_vaf = p_values_fdr_plots[first_idx:last_idx]

p_values_all = c(p_values_fdr_004_pa, p_values_fdr_004_pa_min, p_values_fdr_004_vaf)
...
first_idx = last_idx + 1
last_idx = last_idx + length(p_values_005_pa_min) 
p_values_fdr_005_pa_min = p_values_fdr_plots[first_idx:last_idx]

first_idx = last_idx + 1
last_idx = last_idx + length(p_values_005_vaf) 
p_values_fdr_005_vaf = p_values_fdr_plots[first_idx:last_idx]

p_values_all = c(p_values_fdr_005_pa, p_values_fdr_005_pa_min, p_values_fdr_005_vaf)
...
### separability (distance, volume) - correct vs incorrect trials - time-resolved (bootstrap)
