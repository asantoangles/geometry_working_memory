                ...
                for sequence_length = [3 4]
                    ...
                    if ~isempty(X)
                        ...
                        if ~isfile([outdir '/vaf_' seq_name '.mat'])
                            ...
                            [angle, vaf, angle_min] = compute_alignment_metrics(planes, stim_order);
                        ...
                        if strcmp(performance{perf_i}, 'correct_trials')
                            ...
                            if ~isfile([outdir '/vaf_bootstrap_' seq_name '.mat'])
                                ...
                                for iter_i = 1:iterations_bootstrap
                                    ...
                                    [angle_bootstrap_alliter(:,:,iter_i), vaf_bootstrap_alliter(:,:,iter_i), angle_min_bootstrap_alliter(:,:,iter_i)] = compute_alignment_metrics_within(X_boostrap.X_split1(:,:,iter_i), planes_split1, planes_split2, Y_r, score, stim_order);
                                ...
                                save([outdir '/angle_min_bootstrap_' seq_name '.mat'], 'angle_min_bootstrap', '-v7.3');
