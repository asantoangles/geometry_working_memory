...
path_inputs_supplementary = [path_root '/results/neural_subspaces/' folder_inputs_supplementary];
            ...
            for seg_i = 1:size(time_segments, 1)
                ...
                for perf_i = 1:length(performance)
                    ...
                    for sequence_length = [3 4]
                        ...
                        indir_correct = [path_inputs_supplementary '_supp' num2str(supp_i) '/' subject_ID '/' func2str(fun_i) '/correct_trials/' ...
                            events{event_i} '_' num2str(seg_start) 'to' num2str(seg_end)];
