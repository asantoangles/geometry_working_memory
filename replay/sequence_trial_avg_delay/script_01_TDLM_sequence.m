                        ...
                        if ~size(data_task.trial, 2) == 0
                            ...
                            for input_i = 1:length(inputs)
                                ...
                                for class_i = 1:length(classifiers)
                                    ...
                                    if ~isfolder([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i}])
                                        mkdir([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i}]);
                                    end
                                    ...
                                    if ~isfile([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_length4.mat'])
                                        ...
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_empirical.mat'], 'Msf_empirical', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_empirical.mat'], 'Msb_empirical', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_empirical.mat'], 'Msz_empirical', '-v7.3');
                                
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_all.mat'], 'Msf_all', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_all.mat'], 'Msb_all', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_all.mat'], 'Msz_all', '-v7.3');
                    
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_length3.mat'], 'Msf_length3', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_length3.mat'], 'Msb_length3', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_length3.mat'], 'Msz_length3', '-v7.3');
            
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_length4.mat'], 'Msf_length4', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_length4.mat'], 'Msb_length4', '-v7.3');
                                        save([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_length4.mat'], 'Msz_length4', '-v7.3');
            ...
            for state_i = 1:length(state_spaces)
                ...
                for input_i = 1:length(inputs)
                    ...
                    for class_i = 1:length(classifiers)
                        ...
                        if ~isfile([path_results '/group_results/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/data_individual_plots.mat'])
                            ...
                            for sub_i = 1:length(subjects)
                                ...
                                for ses_i = 1:length(sessions)
                                    ...
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_empirical.mat']); % Msf_empirical
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_empirical.mat']); % Msb_empirical
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_empirical.mat']); % Msz_empirical
                                    ...
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_all.mat']); % Msf_all
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_all.mat']); % Msb_all
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_all.mat']); % Msz_all
                                    ...
                                    null_Msz_thr_pos = percentile(null_Msz(:,1), 97.5);
                                    null_Msz_thr_neg = percentile(null_Msz(:,2), 2.5);
                                    ...
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_length3.mat']); % Msf_length3
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_length3.mat']); % Msb_length3
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_length3.mat']); % Msz_length3
                                    ...
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msf_length4.mat']); % Msf_length4
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msb_length4.mat']); % Msb_length4
                                    load([path_results '/' subject_ID '/' session_ID '/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/Msz_length4.mat']); % Msz_length4
                            ...
                            if ~isfolder([path_results '/group_results/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures'])
                                mkdir([path_results '/group_results/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures']);
                            end
                
                            % save
                            save([path_results '/group_results/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/data_individual_plots.mat'],...
