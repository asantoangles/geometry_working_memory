...
for folder_i = 1:length(folders)
    ...
    try
        ...
        for time_window_i = 1:length(time_windows)
            ...
            disp(time_windows{time_window_i});
                ...
                for input_i = 1:length(inputs)
                    ...
                    for class_i = 1:length(classifiers)
                        ...
                        if isfile([path_results '/group_results/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/data_individual_plots.mat'])
                            ...
                            load([path_results '/group_results/' inputs{input_i} '/' classifier '/' folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/data_individual_plots.mat']);

                            if ~isfile([path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_lengthall.jpeg'])
...
%                                 xlabel('time lag (ms)');
                                ...
                                saveas(gcf, [path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_lengthall.fig']);
...
%                                 xlabel('time lag (ms)');
                                ...
                                saveas(gcf, [path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_length3.fig']);
                                fig = openfig([path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_length3.fig']);
                                saveas(fig, [path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_length3.jpeg']);
...
%                                 xlabel('time lag (ms)');
                                ...
                                saveas(gcf, [path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_length4.fig']);
                                fig = openfig([path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_length4.fig']);
                                saveas(fig, [path_results '/group_results/' inputs{input_i} '/' classifier '/' ...
                                    folder_output '/' predictions_folder '/' state_spaces{state_i} '/' time_windows{time_window_i} '/figures/Msfb_length4.jpeg']);
