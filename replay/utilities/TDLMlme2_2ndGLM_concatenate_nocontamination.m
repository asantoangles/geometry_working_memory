function [Msf, Msb] = TDLMlme2_2ndGLM_concatenate_nocontamination(X,T,nstates,nlags,nshuf,X_trials)

% TDLMlme2_2ndGLM_concatenate_nocontamination estimates forward and backward 
...
%
% [Msf, Msb] = TDLMlme2_2ndGLM_concatenate_nocontamination(X, T, nstates, nlags, nshuf, X_trials)
%
% Inputs:
