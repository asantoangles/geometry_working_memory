...
for sub_i = 1:length(subjects)
    ...
    for ses_i = 1:length(sessions)
        ...
        load([path_preproc '/sub_' subjectID '/sess_' sessionID '/GERE_task_allblocks_wholetrial_baseline1sec_validtrialszthr25.mat']); % data_task
...
if ~isfile([path_preproc '/summary_behav_preproc_n17_zthr25.mat'])

    save([path_preproc '/summary_behav_preproc_n17_zthr25.mat'], 'summary_behav_preproc');
...
load([path_preproc '/summary_behav_preproc_n17_zthr25.mat']); % summary_behav_preproc
